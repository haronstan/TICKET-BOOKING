...
public class SignUp extends AppCompatActivity {
        ...
        // Declare FirebaseAuth and FirebaseFirestore instances
            ...
            @SuppressLint({"MissingInflatedIed", "MissingInflatedId"})
            @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Retrieve user input
            ...
            String myyourName = yourName.getText().toString();
        // Create user account
            createUser(myEmail, myPassword, myyourName, myPhoneNumber);
            }
            });
    ...
    private void createUser(String email, String password, String yourName, int phoneNumber) {
        ...
        // If account creation is successful, save user details
            ...
            saveUserDetails(email, yourName, phoneNumber, userid);
            } else {
    ...
    private void saveUserDetails(String email, String yourName, int phoneNumber, String userid) {

        // Create a User object
            User user = new User(email, yourName, phoneNumber, userid);
