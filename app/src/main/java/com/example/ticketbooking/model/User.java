...
// Retrieve user input
                String myRegular = gridRegular.getText().toString();
                String myVIP = gridVIPSeat.getText().toString();
                int myvipCountTextView = Integer.parseInt(vipCountTextView.getText().toString());
                int myregularCountTextView = Integer.parseInt(regularCountTextView.getText().toString());
                int mytotalTextView = Integer.parseInt(totalTextView.getText().toString());

// Create user account
                createBookSeatsBuyTicket(myRegular, myVIP, myvipCountTextView, myregularCountTextView, mytotalTextView);
...
// Setup seat selection grid
    ...
    private void createBookSeatsBuyTicket() {
